...
describe("Services URL contract", () => { it("builds single-tenant localized URLs (no organization segments)", () => { expect(buildServiceUrl("fr","audit-service","pro")).toBe("/fr/services/pro/audit-service"); expect(buildServiceUrl("en","plumbing","home")).toBe("/en/services/home/plumbing"); expect(buildServiceCategoryUrl("ar","maison")).toBe("/ar/services/maison"); }); });
