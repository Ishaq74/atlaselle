...
- Build `pnpm build` VERT. Tests : **132 fichiers, 1396 tests, 100 % verts** (baseline 2026-09-14 : 15 fichiers / 44 tests en échec — tous réparés ou requalifiés single-tenant). `pnpm check` : **0 erreur** (baseline : 178). Lint : **0 erreur** (21 warnings préexistants).
