import type { AtlaselleModuleCapabilityProviders, AtlaselleModuleDefinition } from "@/core/modules";
...
export const blogModule: AtlaselleModuleDefinition = {
  id: "blog",
  entity: "blog_post",
  ...
  capabilityProviders: defineModuleCapabilityProviders(blogCapabilityProviders satisfies AtlaselleModuleCapabilityProviders),
