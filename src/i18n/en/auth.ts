...
export default {
  ...
  organizations: {
    ...
    blog: {
      title: 'Blog',
      description: 'Manage organization posts, taxonomies and moderation.',
    },
    media: {
      title: 'Media',
      description: 'Manage the organization media library and multilingual alt texts.',
    },
    roles: {
      title: 'Custom Roles',
      description: 'Create and manage custom roles for your organization.',
      builtinTitle: 'Built-in Roles',
      builtinDescription: 'These roles are applied automatically and cannot be modified.',
      noCustomRoles: 'No custom roles for this organization.',
      createRole: 'Create Role',
      editRole: 'Edit',
      deleteRole: 'Delete',
