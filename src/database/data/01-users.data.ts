...
export default [
  {
    ...
    name: "Claire Martin",
    email: "annecy-author-demo@atlaselle.local",
    emailVerified: true,
    role: "user",
  ...
  },
  {
    ...
    name: "Leo Walker",
    email: "annecy-reader-demo@atlaselle.local",
    emailVerified: true,
    role: "user",
  ...
  },
  {
    ...
    name: "Sofia Reyes",
    email: "annecy-critic-demo@atlaselle.local",
    emailVerified: true,
    role: "user",
  ...
  },
  {
    ...
    name: "Marc Dubois",
    email: "annecy-org-admin-demo@atlaselle.local",
    emailVerified: true,
    role: "user",
