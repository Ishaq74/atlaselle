...
- ⚡ **Astro 7.3.1** (SSR, `@astrojs/node`) — Rendu côté serveur, Tailwind CSS 4, TypeScript
...
- 🎨 **Starwind** — 48 composants UI Astro accessibles
...
- ✅ **Tests** — 171 Vitest + 9 E2E × 3 navigateurs
...
| **Tailwind CSS 4** + **Starwind** | Design system (48 composants) |
