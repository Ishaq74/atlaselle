---
description: "Security architect and threat modeler. Validates threat models, access rules, data protection. Use for endpoints, uploads, user content, security reviews."
mode: subagent
---
...
- `.opencode/skills/**` — skills de sécurité et threat modeling (ex. `atlaselle-security`, `atlaselle-auth`, `playwright-best-practices`)
...
- `src/actions/**` — actions admin/voyage/blog/services (vérification des gardes et du RBAC)
...
- `.opencode/skills/**` — security skills documentation (ex. `atlaselle-security`, `atlaselle-auth`)
