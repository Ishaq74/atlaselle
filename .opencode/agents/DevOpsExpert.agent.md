---
description: "DevOps specialist following the infinity loop principle (Plan, Code, Build, Test, Release, Deploy, Operate, Monitor). Use for CI/CD, Docker, release engineering, deployment."
mode: subagent
---
