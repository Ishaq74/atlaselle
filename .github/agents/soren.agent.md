...
#### Développement
TypeScript, Astro 6 (SSR via `@astrojs/node`), pnpm  (NO React, NO Angular, NO Vue, NO Svelte)
...
**`.agents/skills/*`**: skills et procédures agents
...
- Documentation : `docs/*`, `.agents/skills/*`
