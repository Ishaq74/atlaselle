...
export const i18n = {
  ...
  features: {
    en: [
      '⚡ **Astro {ASTRO_VERSION}** (SSR, `@astrojs/node`) — Server-side rendering, Tailwind CSS 4, TypeScript',
      ...
      '🎨 **Starwind** — {ATOMS_COUNT} accessible Astro UI components',
      ...
      '✅ **Testing** — {TEST_SUMMARY} Playwright scenarios × 3 browsers',
    ],
    fr: [
      '⚡ **Astro {ASTRO_VERSION}** (SSR, `@astrojs/node`) — Rendu côté serveur, Tailwind CSS 4, TypeScript',
      ...
      '🎨 **Starwind** — {ATOMS_COUNT} composants UI Astro accessibles',
      ...
      '✅ **Tests** — {TEST_SUMMARY} × 3 navigateurs',
    ],
    ar: [
      '⚡ **Astro {ASTRO_VERSION}** (SSR, `@astrojs/node`) — عرض من جانب الخادم، Tailwind CSS 4، TypeScript',
      ...
      '🎨 **Starwind** — {ATOMS_COUNT} مكون واجهة مستخدم Astro سهل الوصول',
      ...
      '✅ **الاختبارات** — {TEST_SUMMARY} × 3 متصفحات',
    ],
    es: [
      '⚡ **Astro {ASTRO_VERSION}** (SSR, `@astrojs/node`) — Renderizado del lado del servidor, Tailwind CSS 4, TypeScript',
      ...
      '🎨 **Starwind** — {ATOMS_COUNT} componentes UI Astro accesibles',
      ...
      '✅ **Testing** — {TEST_SUMMARY} × 3 navegadores',
    ],
  },
  auth: {
